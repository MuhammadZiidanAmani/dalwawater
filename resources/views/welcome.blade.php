...
<head>
    ...
    <style>
        ...
        *{box-sizing:border-box}body{margin:0;background:var(--bg);color:var(--text)}button,input,select,textarea{font:inherit}button{cursor:pointer}
        ...
        .sidebar-overlay{display:none;position:fixed;inset:0;background:rgba(15,23,42,0.6);z-index:40;opacity:0;transition:opacity 0.3s ease;backdrop-filter:blur(2px)}
...
@else
<div class="shell">
    <div class="sidebar-overlay" onclick="document.querySelector('.side').classList.remove('open'); this.classList.remove('active');"></div>
    <aside class="side">
        <div class="brand">
            Dalwa Water Tegal
        </div>
    ...
    <div class="main-wrapper">
        <header class="topbar">
            <button class="hamburger" onclick="document.querySelector('.side').classList.toggle('open'); document.querySelector('.sidebar-overlay').classList.toggle('active');">
            ...
            <div class="grid4" style="grid-template-columns:repeat(3,minmax(0,1fr))">
                ...
                <article class="card">
                    <div class="metric">
                        <div class="metric-info">
                            <h3>Pendapatan</h3>
                            <div class="value" style="font-size:22px">{{ $rupiah($stats['today_profit']) }}</div>
                        </div>
                        <div class="metric-icon">
                            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><line x1="12" y1="1" x2="12" y2="23"></line><path d="M17 5H9.5a3.5 3.5 0 0 0 0 7h5a3.5 3.5 0 0 1 0 7H6"></path></svg>
                        </div>
